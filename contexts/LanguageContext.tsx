...
const translations = {
  ne: {
    ...
    "home.description":
      "घर सरसफाइदेखि ट��यूशन, डिजिटल सेवादेखि रचनात्मक कामसम्म - विश्वसनीय सेवा प्रदायकहरू फेला पार्नुहोस्!",
    ...
    "auth.signin.rememberMe": "म��ाई सम्झनुहोस्",
    ...
    "auth.signup.roleProvider": "���ेवा प्रदायक",
    ...
    "dashboard.provider.weeklyEarnings": "साप्ताहिक आम���दानी",
    ...
    "booking.serviceDetailsPlaceholder":
      "क��पया आफ्ना आवश्यकताहरू विस्तारमा लेख्नुहोस्...",
    ...
    "booking.specialInstructionsPlaceholder":
      "कुनै विशेष निर्दे��न वा टिप्पणी...",
    ...
    "findServices.sortByReviews": "समी���्षाअनुसार मिलाउनुहोस्",
  ...
  en: {
    ...
    "becomeProvider.verification": "Document verification process",
