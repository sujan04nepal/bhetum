...
const translations = {
  ne: {
    ...
    "home.readyDesc": "हजारौं खुसी ग्राहक र सेवा प्रदायकहरूसँग ज���डिनुहोस्!",
    ...
    "auth.signup.alreadyHaveAccount": "पहिले नै ख���ता छ?",
    ...
    "dashboard.seeker.totalBookings": "क���ल बुकिङहरू",
    ...
    "findServices.in": "मा",
    "findServices.sortByRating": "रेटिङअनुसार मिलाउनुहोस��",
    ...
    "becomeProvider.description": "विव���ण",
    ...
    "services.sortBy": "क्रमबद्ध गर्नुहोस��",
