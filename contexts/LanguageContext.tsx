...
const translations = {
  ne: {
    ...
    "home.becomeProvider": "से��ाप्रदायक बन्नुहोस्",
    ...
    "auth.signup.seekerDesc":
      "घर सरसफाइ, ट्यूशन, डिजिटल सेवा र अन्य आवश्यकताहरूका लागि विश्वसनीय सेवा प्रदायकहरू फेला पार्��ुहोस्।",
    ...
    "dashboard.provider.applications": "आव��दनहरू",
    ...
    "dashboard.seeker.viewAllBookings": "सबै बुकिङहरू हेर्नुहोस��",
    ...
    "form.booking.paymentMethod": "भुक्ता��ीको तरिका",
    ...
    "form.profile.workingDays": "काम गर्ने दि��हरू",
    ...
    "becomeProvider.startEarning": "आम्दान�� सुरु गर्नुहोस्!",
