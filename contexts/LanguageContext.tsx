...
const translations = {
  ne: {
    ...
    "footer.howItWorks": "कस��ी काम गर्छ",
    ...
    // Auth Pages
    "auth.signin.title": "सेवा खो���मा लगइन गर्नुहोस्",
    "auth.signin.subtitle": "आफ्नो खातामा पहुँच गर्नुहोस्",
    "auth.signin.email": "इमे�� ठेगाना",
    ...
    "auth.signup.provideServices": "सेवा प्रदान गर्न च��हन्छु",
    ...
    "form.booking.selectTime": "समय चयन गर्नु���ोस्",
    ...
    "form.booking.termsAgree": "मैले सेवाका सर्तहरूमा ��हमति जनाएको छु।",
    ...
    "booking.phonePlaceholder": "तपाईंको ��ोन नम्बर",
    ...
    "becomeProvider.reviewProcess":
      "२४ घण्टा भित्�� तपाईंको आवेदन समीक्षा गरिनेछ",
    ...
    "services.relevance": "प्र���संगिकता",
    ...
    "admin.userManagement": "प्रयोगक���्ता व्यवस्थापन",
    ...
    "admin.serviceCategories": "स��वा श्रेणीहरू",
